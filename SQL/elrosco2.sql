...
INSERT INTO `USUARIO` (`nombreUsuario`, `correoUsuario`, `fechaNacimiento`, `contrasenia`) VALUES
('s1', 's1@s', '2024-11-16', '$2y$10$T/QL1lj6kHtJ.PgfrrQpAOTpQcYFsQNhj6eQy0Tsq4T7PsElgoF56'),
('s2', 's2@s', '2024-11-16', '$2y$10$tpkow6dxO.CQuneTWSfjveB7z73O9fARwQyz6FQ9xlECnD/k5yzzq'),
('s3', 's3@s', '2024-11-16', '$2y$10$jhct3YfhmrbxwM/rIy/4PuaD9rrOtdcR3Vs/xVqOAo4Pz6/gI62NO');

-- INSERTAR ROSCOS
INSERT INTO `ROSCO` (`estadoRosco`) VALUES
('completo'),
('incompleto'),
('completo'),
('completo'),
...
-- INSERTAR PARTIDAS
INSERT INTO `PARTIDA` (`ganador`, `tiempo`, `dificultadPartida`, `ayudaAdicional`) VALUES
(1, '00:05:00', 'baja', TRUE),
(2, '00:03:00', 'media', FALSE),
(3, '00:02:00', 'alta', TRUE);

INSERT INTO `PARTIDA_USUARIO` (`idPartida`, `idUsuario`, `puntaje`, `tiempoRestante`, `idRosco`) VALUES
(1, 1, 10, '00:01:00', 1),
(1, 2, 9, '00:01:00', 2),
(2, 2, 8, '00:01:00', 1),
(2, 3, 7, '00:01:00', 2),
...
INSERT INTO `ROSCO_PREGUNTA` (`idRosco`, `idPregunta`, `estadoRespuesta`) VALUES
(1, 1, 'correcto'),
(1, 2, 'correcto'),
(1, 3, 'incorrecto'),
(2, 1, 'correcto'),
...
INSERT INTO `HISTORIAL` (`idUsuario1`, `idUsuario2`, `victoriasJugador1`, `victoriasJugador2`) VALUES
(1, 2, 1, 0),
(2, 3, 1, 0),
(1, 3, 1, 0);